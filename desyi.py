...
TELEGRAM_BOT_TOKEN = "8768801941:AAGZiLyIRyLw9GwyHYi223md13qaouZCm_U"  # <-- PUT YOUR TOKEN HERE
    ...
    # ============== DIRECT AADHAAR / EID FLOW (with name) ==============
        ...
        if re.match(r'^\d{12}$', uid):
            ...
            send_message(
                ...
                f"<b>〔 Step 2 — Name 〕</b>\n\n"
                f"▸  Enter your full name as on Aadhaar\n\n"
                f"<i>◌  This is required to unlock your PDF.</i>",
                reply_markup=get_cancel_keyboard()
            )
        else:
            send_message(
        ...
        if image_bytes:
            sd = get_session(chat_id)['data']
            set_session(chat_id, 'awaiting_captcha_direct', {
                **sd,
