...
# ============== ERROR FORMATTER ==============
def format_otp_error(error_msg):
    """Replace 'No Records Found' with a user-friendly message."""
    if error_msg and "No Records Found" in error_msg:
        return "No Aadhaar linked to this number."
    return error_msg

# ============== CONFIG ==============
DIVIDER         = "━━━━━━━━━━━━━━━━━━━━━━━"
BOT_NAME        = "✜ Uɪᴅᴀɪ-ɢʀᴀᴍ"          # exact stylized name
OWNER_ID        = 8901139503
